...
function desc(){
    ...
    p1.innerText = "The Beauty Sleigh-ers are back! Treat yourself this holiday season with 6+ hot-selling beauty essentials inside the X-Must Haves December Fab Bag."

    let p2 = document.createElement("p")
    p2.innerText = "Here's what you can expect inside your December Fab Bag:"
    ...
    li1.innerText = "Revolution Pro Supreme Matte Lip Pigment of your choice!*"

    let li2 = document.createElement("li")
    li2.innerText = "K Bizz French Pink Clay"

   let  li3 = document.createElement("li")
    li3.innerText = "moha: Herbal Face Wash"

    let li4 = document.createElement("li")
    li4.innerText = "Adideva Naturals Ananda Miraculous Face Serum"
