...
function desc(){
    ...
    p1.innerText = "You & Beauty - it's a love match! Treat yourself with irresistible flirty finds inside the Colour Me Cupid February Fab Bag."

    let p2 = document.createElement("p")
    p2.innerText = "Here's what you can expect inside your February Fab Bag:"
    ...
    li1.innerText = "Teen Teen Ceremonial Makeup 8 Color Eyeshadow Kit of your choice!*"

    let li2 = document.createElement("li")
    li2.innerText = "Teen Trendz 5 in 1 Matte Me Lipstick of your choice!*"

    let li3 = document.createElement("li")
    li3.innerText = "Coco Soul Nourishing Body Lotion"

    let li4 = document.createElement("li")
    li4.innerText = "The Soap Company India Saffron Soothing Sorbet"
